                ...
                <div class="mx-auto px-6 py-8">
                    ...
                    <div class="bg-white shadow-md rounded my-6">
                        <table class="text-left w-full border-collapse">
                            ...
                            <tbody> <?php $__currentLoopData = $movies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $movie): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <tr class="hover:bg-grey-lighter">
